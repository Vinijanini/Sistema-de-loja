...
cursor.execute("CREATE TABLE IF NOT EXISTS produtos (nome text, preço float, quantidade int)")
cursor.execute("CREATE TABLE IF NOT EXISTS usuarios (nome text, email text, login text, senha text)")
cursor.execute("CREATE TABLE IF NOT EXISTS vendas (cliente text, email text, carrinho text, preço float, data_hora text)")
